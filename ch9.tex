...
The research was organized around three complementary objectives:
(1)~characterizing the radiation response of halide perovskite
materials across multiple compositions and radiation types,
(2)~developing and demonstrating perovskite-based detection devices
for specific nuclear monitoring applications, and (3)~implementing
and validating radiation-tolerant FPGA-based digital instrumentation
systems for operation in nuclear environments.  A fourth, ancillary
objective addressed thermal radiation sensing concepts as an
alternative pathway for nuclear environment monitoring.  The following
...
$\sim$1000~$\mu$C\,(Gy$_{\rm air}$\,cm$^2$)$^{-1}$ at 4~V bias,
